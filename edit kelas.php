	...
	<div class="container" style="margin-top:20px">
		...
		<form action="edit kelas.php?id=<?php echo $id; ?>" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="nama_makul" class="form-control" value="<?php echo $data['nama_makul']; ?>" required>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="jam" class="form-control" required>
						...
						<option value="1" <?php if($data['jam'] == '1'){ echo 'selected'; } ?>>1</option>
						<option value="2" <?php if($data['jam'] == '2'){ echo 'selected'; } ?>>2</option>
						<option value="3" <?php if($data['jam'] == '3'){ echo 'selected'; } ?>>3</option>
						<option value="4" <?php if($data['jam'] == '4'){ echo 'selected'; } ?>>4</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
