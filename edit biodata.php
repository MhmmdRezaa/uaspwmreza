...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE biodata SET foto='$foto', nama='$nama', nim='$nim', jurusan='$jurusan', alamat='$alamat' WHERE id='$id'") or die(mysqli_error($koneksi));
			
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="edit biodata.php?id='.$id.'";</script>';
			}else{
		...
		<form action="edit biodata.php?id=<?php echo $id; ?>" method="post">
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">FOTO</label>
				<div class="col-sm-10">
					<input type="file" name="foto" value="<?php echo $data['foto']; ?>" readonly required>
				</div>
			</div>
			<div class="form-group row">
